...
public class RestaurantFakeApi implements RestaurantApi {
    ...
    List<Review> reviews = Arrays.asList(
            ...
            new Review("Alice Murphy", "https://randomuser.me/api/portraits/women/00.jpg", "The pizza here is just perfect, love the crust!", 5),
            new Review("Brian Phillips", "https://randomuser.me/api/portraits/men/01.jpg", "The atmosphere was great, but the food was a bit bland.", 3),
            new Review("Clara Mitchell", "https://randomuser.me/api/portraits/women/02.jpg", "Amazing vegan options, highly recommend!", 5),
            new Review("David Turner", "https://randomuser.me/api/portraits/men/03.jpg", "Great place for family dinners!", 4),
            new Review("Ella Walker", "https://randomuser.me/api/portraits/women/04.jpg", "Not as good as the last time I visited.", 2),
            new Review("Felix Martin", "https://randomuser.me/api/portraits/men/05.jpg", "The seafood was fresh and delicious!", 5),
            new Review("Grace Taylor", "https://randomuser.me/api/portraits/women/06.jpg", "The sandwiches were amazing, great value!", 4),
            new Review("Henry Davis", "https://randomuser.me/api/portraits/men/07.jpg", "The steak was a little tough, not worth the price.", 2),
            new Review("Ivy Lewis", "https://randomuser.me/api/portraits/women/08.jpg", "A lovely place to grab coffee and hang out.", 4),
            new Review("Jackie Hernandez", "https://randomuser.me/api/portraits/women/09.jpg", "Desserts were so sweet and the coffee was perfect.", 5),
